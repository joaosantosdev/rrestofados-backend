...
forma_pag_controller = Blueprint('formaPagamento', __name__, url_prefix='/formapagamento')
forma_pag_schema = FormaPagamentoSchema()


@forma_pag_controller.route('', methods=['GET'])
@security_token()
def get():
...
@forma_pag_controller.route('/all', methods=['GET'])
@security_token()
def get_all():
...
@forma_pag_controller.route('/<int:id>', methods=['GET'])
@security_token()
def get_by_id(id):
...
@forma_pag_controller.route('', methods=['POST'])
@security_token()
def post():
...
@forma_pag_controller.route('/<int:id>', methods=['PUT'])
@security_token()
def put(id):
    forma = FormaPagamento.filter(id=id)
    if not forma:
